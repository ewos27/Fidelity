  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">Omega Capital Investment</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            <Badge className="bg-gradient-to-r from-green-500 to-emerald-500 text-black px-4 py-2 backdrop-blur-sm font-semibold">
              About Omega Capital Investment
            </Badge>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-4xl mx-auto leading-relaxed">
              Welcome to Omega Capital Investment, where we're dedicated to revolutionizing the way the world approaches finance. 
          ...
          <Card className="backdrop-blur-md bg-white/10 border-white/20">
            <CardContent className="p-8">
              ...
              <p className="text-slate-300 text-lg leading-relaxed max-w-4xl mx-auto">
                Omega Capital Investment is a Fortune 200 company shaping the future of finance through innovation and investments 
                in disruptive technologies throughout North America. With our roots tracing back nearly 100 years, 
                Omega Capital Investment has been a trailblazer in the financial industry since our inception. 
                ...
                Since our humble beginnings nearly a century ago, Omega Capital Investment has been pioneering new technologies, 
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Why Choose Omega Capital Investment?</h2>
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
              The experienced professionals leading Omega Capital Investment's mission
            </p>
          </div>
          ...
          <Card className="backdrop-blur-md bg-white/10 border-white/20">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
                Join thousands of investors who trust Omega Capital Investment for their financial future
              </p>
