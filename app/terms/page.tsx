          ...
          <div className="space-y-12">
            ...
            <Card className="bg-slate-800 border-slate-700">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-slate-300">
                  <p>
                    These Terms of Service ("Terms") govern your use of the Omega Capital Investment trading platform 
            ...
            <Card className="bg-slate-800 border-slate-700">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-slate-300">
                  <p>
                    To the maximum extent permitted by law, Omega Capital Investment shall not be liable for any 
      ...
      <footer className="bg-slate-800 border-t border-slate-700 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-slate-700 mt-8 pt-8 text-center text-slate-400">
            <p>&copy; 2024 Omega Capital Investment. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
